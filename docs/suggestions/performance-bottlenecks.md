...
- **🧪 验证**：`tests/relay.test.mjs` 8/8 通过；`npm run test:coverage` 792/792 通过，总体 line 96.82%、branch 83.51%、function 96.50%。`parse-relay.mjs` 提升到 line 89.21%、branch 69.90%、function 91.80%；`update-commercial-relay.mjs` 提升到 line 76.65%、branch 86.84%、function 90.91%。
