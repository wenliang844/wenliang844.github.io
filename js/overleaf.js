    ...
    sections: [
      ...
      },
      {
        ...
        entries: [
          ...
          {
            title: "危机干预与 MDT 协作",
            subtitle: "自伤自杀风险 / 创伤危机 / 跨学科会诊",
            meta: "掌握",
            desc: "具备高风险个案识别、分级处置、转介随访和安全计划制定经验，能够在精神科、神经科、社工与护理团队之间推动诊断共识和照护衔接。"
          },
          {
            title: "临床研究与教学",
            subtitle: "病例研究 / 诊断质量改进 / 医学教育",
            meta: "熟练",
            desc: "具备病例研究、论文写作、诊断流程优化和临床带教经验，能够将循证研究转化为可执行的评估流程与培训材料。"
          }
        ]
      }
    ]
