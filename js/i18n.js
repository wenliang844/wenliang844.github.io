...
(function () {
  ...
  const EN = {
    ...
    "head.title.chat": "Temporary Chat :: CWLBlog",
    "head.desc.chat": "Create or join a temporary real-time chat room that is cleared after two hours of inactivity.",
    ...
    // 临时聊天室
    "chat.eyebrow": "Temporary session",
    "chat.title": "Temporary Chat",
    "chat.lead": "Create a room or join an active conversation with an invite code.",
