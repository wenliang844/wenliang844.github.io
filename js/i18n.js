...
(function () {
  ...
  const EN = {
    ...
    "tools.h1": "Toolbox",
    "tools.lead": "Useful browser-only tools for JSON, timestamps, encoders, hashes, passwords, colors, regex, Markdown, diff, cron and QR codes.",
    ...
    "assistant.page.tools.desc": "JSON, timestamp, encoder, hash, password, color, regex, Markdown, diff, cron and QR tools are in the online toolbox.",
