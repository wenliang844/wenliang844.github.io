...
(function () {
  ...
  const EN = {
    ...
    "head.title.ai": "AI Navigation :: CWLBlog",
    "head.desc.ai": "A categorized directory of frequently used AI websites and tools.",
    ...
    "assistant.quick.ai": "View AI navigation",
    ...
    "assistant.page.ai.desc": "Frequently used AI websites and tools are organized in AI Navigation.",
    "assistant.page.relay.desc": "The AI relay ranking lets you filter ChatGPT/OpenAI and Claude/Anthropic-compatible routes.",
    "assistant.page.tools.desc": "JSON, timestamp, Base64, URL, UUID and JWT tools are in the online toolbox.",
    ...
    "assistant.page.contact.desc": "Contact links and feedback are on the contact page.",
