...
(function () {
  ...
  const EN = {
    ...
    "head.title.chat": "Online Chat :: CWLBlog",
    "head.desc.chat": "Join the CWLBlog real-time group chat hosted by Minnit Chat.",
    ...
    // 在线聊天室
    "chat.eyebrow": "Live conversation",
    "chat.title": "Online Chat",
    "chat.lead": "Choose a nickname to join the live group chat.",
    "chat.provider": "CWLBlog group chat",
    "chat.privacy": "This room is hosted by Minnit Chat. Do not send passwords, contact details, or other sensitive information.",
    "chat.newTab": "Open in new window",
    "chat.lobby.title": "Enter chat",
    "chat.lobby.status": "Up to 20 people. Rooms are cleared after 2 hours of inactivity.",
    "chat.lobby.privacy": "Anonymous access",
    "chat.nickname": "Nickname",
    "chat.nickname.ph": "2–20 characters",
    "chat.create": "Create room",
    "chat.or": "or",
    "chat.code": "Invite code",
    "chat.code.ph": "8-character code",
    "chat.join": "Join",
    "chat.room.label": "Room",
    "chat.online": " online",
    "chat.share": "Share invite link",
    "chat.copy": "Copy invite link",
    "chat.leave": "Leave room",
    "chat.message": "Message",
    "chat.message.ph": "Type a message",
    "chat.send": "Send message",
    "chat.anonymous": "Anonymous",
    "chat.state.connecting": "Connecting",
    "chat.state.connected": "Connected",
    "chat.state.reconnecting": "Reconnecting",
    "chat.state.disconnected": "Disconnected",
    "chat.state.expired": "Room expired",
    "chat.state.creating": "Creating room…",
    "chat.state.left": "You left the room.",
    "chat.state.copied": "Invite link copied.",
    "chat.system.joined": "{name} joined the room",
    "chat.system.left": "{name} left the room",
    "chat.system.truncated": "Older messages were removed at the room limit.",
    "chat.error.disabled": "Chat is currently disabled.",
    "chat.error.origin": "This site cannot connect to chat.",
    "chat.error.notFound": "The room does not exist or has expired.",
    "chat.error.full": "The room is full.",
    "chat.error.nickname": "Nickname must contain 2–20 characters.",
    "chat.error.message": "Message must contain 1–500 characters.",
    "chat.error.rate": "Too many requests. Try again shortly.",
    "chat.error.expired": "The room was cleared after inactivity.",
    "chat.error.generic": "Chat request failed. Try again later.",
    "chat.error.code": "Enter a valid 8-character invite code.",
    "chat.error.copy": "Copy failed. Copy the link from the address bar.",
    "chat.error.unconfigured": "Chat service is not configured.",
