...
(function () {
  ...
  const EN = {
    ...
    "tools.h1": "Toolbox",
    "tools.lead": "Useful browser-only tools for JSON, timestamps, encoders, hashes, passwords, colors, regex, Markdown, diff, cron, QR codes, YAML, URL parsing and text processing.",
    ...
    "tools.nav.markdown": "Markdown Preview",
    ...
    "tools.markdown.title": "Markdown Preview",
    "tools.markdown.desc": "Render Markdown to sanitized HTML preview.",
    ...
    "sponsor.domestic.desc": "WeChat / Alipay QR codes can be connected here. The placeholders avoid inventing payment codes.",
    "sponsor.domestic.aria": "Domestic QR placeholders",
    "sponsor.domestic.wechat": "WeChat QR",
